...
export class RegisterComponent {
  registerForm = this.fb.group({
    ...
    password_c: [ null, Validators.required],
  ...
  onSubmit() {
    ...
    if (this.registerForm.value.password === this.registerForm.value.password_c ){
      console.log('passwords are the same'); // TODO: check in the form itself
    }
