...
export class EngineBBLService {
  ...
  public animate(): void {
    ...
    this.logger.log('scene is being animated');
  ...
  public drawQueel(): void {
    ...
    const woodMaterial = new StandardMaterial('wood_queel', this.scene);
    const woodTexture = new WoodProceduralTexture(name + 'text', 1024, this.scene);
    woodTexture.ampScale = 180.0;
    woodMaterial.diffuseTexture = woodTexture;
    extrusion.material = woodMaterial;
  }
  /**
